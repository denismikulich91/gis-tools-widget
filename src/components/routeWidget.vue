<template>
    <div class="col">
        ...
        <p>{{ travelChoice }}</p>
        <div class="flex row">
            <q-input v-model="distance" class="col-6" square label="Distance" label-color="positive" />
            <q-input v-model="duration" class="col-6" square label="Duration" label-color="positive" />
        </div>
